...
function extractRelevantKeywords(text: string): string[] {
    const stopwords: string[] = ['the', 'in', 'on', 'at', 'of', 'and', 'a', 'to', 'for', 'with', 'is', 'was', 'were', 'by', 'as', 'an', 'are', 'this', 'that', 'it', 'from', 'be', 'have', 'has', 'had', 'do', 'did', 'but', 'about', 'not', 'or', 'if', 'they', 'their', 'them', 'been', 'can', 'all', 'any', 'will', 'also', 'your', 'you', 'I', 'my', 'me', 'we', 'our', 'us', 'he', 'she', 'him', 'her', 'his', 'hers', 'its', 'who', 'whom', 'which', 'what', 'where', 'when', 'why', 'how'];

    let words = text.match(/\b(\w+)\b/g)?.filter(word => {
        return /^[A-Z]/.test(word) && !stopwords.includes(word.toLowerCase()) && /^[a-zA-Z]+$/.test(word);
    }) || [];
